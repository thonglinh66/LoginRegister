        ...
        <div class="row align-items-center mb-5">
          ...
          <div class="row" >
            ...
            <div class="mb-5">
              ...
              <ul class="list-unstyled m-0 p-0">
              <li class="d-flex align-items-start mb-2"><span style="padding-top:6px;" class="icon-check_circle mr-2 text-muted"></span><span>Name:&nbsp;&nbsp;{{$employee->fullname }}</span></li>
              <li class="d-flex align-items-start mb-2"><span style="padding-top:6px;" class="icon-check_circle mr-2 text-muted"></span><span>Chức vụ:&nbsp;&nbsp;{{$employee->position }}</span></li>
              </ul>
            </div>
          </div>
          </div>
