...
@section('active')
  <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="{{route('technicians.history')}}">History</a>
    </li>
    <li class="nav-item">
    ...
    <div class="container">
      <div class="row slider-text align-items-center justify-content-center">
        ...
        <h1 class="mb-4" data-aos="fade-up" data-aos-delay="">History</h1>
          <p class="custom-breadcrumbs" data-aos="fade-up" data-aos-delay="100"><a href="{{ route('technicians.index') }}">Home</a> <span class="mx-3">/</span> History</p>
        </div>
      </div>
    </div>
  </div>
