    ...
    <div class="container">
      <div class="row slider-text align-items-center justify-content-center">
        ...
        <h1 class="mb-4" data-aos="fade-up" data-aos-delay="">Details</h1>
          <p class="custom-breadcrumbs" data-aos="fade-up" data-aos-delay="100"><a href="{{ route('technicians.index') }}">Home</a> <span class="mx-3">/</span> Details</p>
        </div>
      </div>
    </div>
  </div>
